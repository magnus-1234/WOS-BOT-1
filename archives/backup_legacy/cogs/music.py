...
class PlayerControlView(discord.ui.View):
    ...
    async def previous(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        """Play previous track"""
        try:
    ...
    async def skip(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        """Skip to next track"""
        try:
    ...
    async def stop(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def loop(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def shuffle(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        """Shuffle the queue"""
        try:
    ...
    async def volume_down(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def volume_up(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def seek_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def effects_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def search_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        """Search for music"""
        try:
            # Open search modal
...
class SeekModal(discord.ui.Modal):
    ...
    def __init__(self, player: CustomPlayer):
        super().__init__(title="Seek to Position")
        self.player = player
    ...
    async def on_submit(self, interaction: discord.ApplicationContext):
...
class SearchModal(discord.ui.Modal):
    ...
    def __init__(self, player: CustomPlayer, bot):
        super().__init__(title="Search for Music")
        self.player = player
        self.bot = bot
...
class TrackActionView(discord.ui.View):
    ...
    async def play_now(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def add_to_queue(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def back_to_results(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
...
class EffectsControlView(discord.ui.View):
    ...
    async def bass_boost_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def speed_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def pitch_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def nightcore_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def slowed_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def reset_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        """Reset all effects"""
        try:
...
class SpeedControlModal(discord.ui.Modal):
    """Modal for speed adjustment"""

    def __init__(self, player: CustomPlayer, effects_view: EffectsControlView):
        super().__init__(title="Speed Control")
        self.player = player
        self.effects_view = effects_view
...
class PitchShiftModal(discord.ui.Modal):
    """Modal for pitch adjustment"""

    def __init__(self, player: CustomPlayer, effects_view: EffectsControlView):
        super().__init__(title="Pitch Shift Control")
        self.player = player
        self.effects_view = effects_view
...
class QueuePaginationView(discord.ui.View):
    ...
    async def previous_page(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        """Go to previous page"""
        if self.page > 0:
            self.page -= 1
            await interaction.response.edit_message(embed=self.get_embed(), view=self)
    ...
    async def next_page(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        """Go to next page"""
    ...
    async def clear_queue(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        """Clear the queue"""
        self.player.queue.clear()
        await interaction.response.edit_message(embed=self.get_embed(), view=self)
...
class GenreSelectionView(discord.ui.View):
    ...
    async def pop_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        """Play pop music"""
    ...
    async def rock_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        """Play rock music"""
    ...
    async def hiphop_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        """Play hip hop music"""
    ...
    async def jazz_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        """Play jazz music"""
    ...
    async def electronic_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def classical_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
    ...
    async def country_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        """Play country music"""
    ...
    async def lofi_button(self, interaction: discord.ApplicationContext, button: discord.ui.Button):
        """Play lofi music"""
...
class Music(commands.Cog):
    ...
    async def safe_play(self, player: CustomPlayer, track: wavelink.Playable, interaction: discord.ApplicationContext = None) -> bool:
    ...
    async def get_player(self, interaction: discord.ApplicationContext, query: str = None) -> Optional[CustomPlayer]:
    ...
    @discord.slash_command(name="play", description="Play a song or add it to the queue")
    async def play(self, interaction: discord.ApplicationContext, query: str):
        """Play music from various sources"""
        try:
            if not interaction.response.is_done():
                await interaction.response.defer()
        except (discord.HTTPException, discord.NotFound):
            pass # Interaction already acknowledged or timed out
    ...
    async def pause(self, interaction: discord.ApplicationContext):
        """Pause playback"""
        player: CustomPlayer = interaction.guild.voice_client
    ...
    async def resume(self, interaction: discord.ApplicationContext):
        """Resume playback"""
        player: CustomPlayer = interaction.guild.voice_client
    ...
    async def skip(self, interaction: discord.ApplicationContext, amount: int = 1):
        """Skip tracks"""
        try:
            player: CustomPlayer = interaction.guild.voice_client
    ...
    @discord.slash_command(name="stop", description="Stop playback and disconnect")
    ...
    @discord.slash_command(name="nowplaying", description="Show currently playing track")
    async def nowplaying(self, interaction: discord.ApplicationContext):
        """Show now playing"""
        player: CustomPlayer = interaction.guild.voice_client
    ...
    async def queue(self, interaction: discord.ApplicationContext, page: int = 1):
        """Display queue"""
        player: CustomPlayer = interaction.guild.voice_client
    ...
    @discord.slash_command(name="volume", description="Set playback volume")
    async def volume(self, interaction: discord.ApplicationContext, volume: int):
        """Set volume"""
        player: CustomPlayer = interaction.guild.voice_client
    ...
    async def shuffle(self, interaction: discord.ApplicationContext):
        """Shuffle queue"""
        player: CustomPlayer = interaction.guild.voice_client
    ...
    @discord.slash_command(name="loop", description="Set loop mode")
    async def loop(self, interaction: discord.ApplicationContext, mode: str):
        """Set loop mode"""
        player: CustomPlayer = interaction.guild.voice_client
    ...
    async def clear(self, interaction: discord.ApplicationContext):
        """Clear queue"""
        player: CustomPlayer = interaction.guild.voice_client
    ...
    @discord.slash_command(name="remove", description="Remove a track from the queue")
    async def remove(self, interaction: discord.ApplicationContext, position: int):
    ...
    @discord.slash_command(name="seek", description="Seek to a position in the current track")
    async def seek(self, interaction: discord.ApplicationContext, position: int):
        """Seek to position"""
        player: CustomPlayer = interaction.guild.voice_client
    ...
    @discord.slash_command(name="previous", description="Play the previous track from history")
    async def previous(self, interaction: discord.ApplicationContext):
        """Play previous track"""
        await interaction.response.defer()
    ...
    @discord.slash_command(name="playlist", description="Manage your saved playlists")
    async def playlist(self, interaction: discord.ApplicationContext):
